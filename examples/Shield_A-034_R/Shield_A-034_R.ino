/* D0-D7, RV1
 * turning on LEDs 
 * - from D0 to D7 depending on potentiometer shaft position
...
void setup() {
  ...
  activeLED = map(potentiometerValue, 0, 1023, 0 , 7);
...
void loop() {
  ...
  // if so, turn off the last active led
